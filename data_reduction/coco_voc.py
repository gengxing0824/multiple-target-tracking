...
json_coco_person = ['/opt/hangzhou1907/projects/PL-ZSD_Release/Dataset/annotations/person_keypoints_train2014.json','/opt/hangzhou1907/projects/PL-ZSD_Release/Dataset/annotations/person_keypoints_val2014.json']
out_dir = 'train.json'
...
for i in json_coco_person:
    ...
    for im in dict_json['images']:
        dict_image = {}
        dict_image['file_name'] = im['file_name']
        dict_image['height'] = 0
        dict_image['width'] = 0
        dict_image['id'] = im['id'] + 1000000
        out_dict['images'].append(deepcopy(dict_image))

    for anno in dict_json['annotations']:
        dict_ann = {}
        dict_ann['segmentation'] = [[]]
        dict_ann['area'] = 0
        dict_ann['iscrowd'] = 0
        dict_ann['image_id'] = anno['image_id'] + 1000000
